                    ...
                    <div class="col-lg-6">
                        <div class="asset-detail-info">
                            ...
                            <div class="asset-detail-actions">
                                <a href="<?php echo e(route('capturist.assets.qr')); ?>" class="generate-qr-btn">
                                    <span class="qr-icon">
                    ...
                    <div class="col-lg-6">
                        <div class="asset-image-panel">
                            <div class="asset-image-frame">
                                <img src="<?php echo e(asset('img/qr-code-icon.png')); ?>" alt="Laptop Asus ROG" class="asset-detail-image">
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Yahir\actiscan\actiscan\resources\views/capturist/show-asset.blade.php ENDPATH**/ ?>