            ...
            <div class="row align-items-center g-4 reset-body">
                <div class="col-lg-7">
                    <form class="reset-form">
                        ...
                        <div class="reset-button-wrapper">
                            <a href="<?php echo e(route('login')); ?>" class="btn confirm-reset-btn">Confirmar</a>
                        </div>
                    </form>
                </div>
                ...
                <div class="col-lg-5 d-flex justify-content-center">
                    <div class="reset-illustration">
                        <img src="<?php echo e(asset('img/reset-password-illustration.png')); ?>" alt="Reset Password Illustration" class="reset-illustration-img">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Yahir\actiscan\actiscan\resources\views/auth/reset-password.blade.php ENDPATH**/ ?>