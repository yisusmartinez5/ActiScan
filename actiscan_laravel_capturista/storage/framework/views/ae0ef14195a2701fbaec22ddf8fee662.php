        ...
        <div class="row g-0 align-items-center h-100">
            ...
            <div class="col-lg-6 d-flex justify-content-center align-items-center left-panel">
                <div class="logo-panel">
                    <img src="<?php echo e(asset('img/actiscan-logo.png')); ?>" alt="Logo ActiScan" class="main-logo">
                </div>
            </div>
            ...
            <div class="col-lg-6 d-flex justify-content-center align-items-center right-panel">
                <div class="login-box">
                    ...
                    <form>
                        ...
                        <div class="mb-3">
                            <a href="<?php echo e(route('forgot.password')); ?>" class="forgot-link">Olvide contraseña</a>
                        </div>

                        <div class="text-center">
                            <a href="<?php echo e(route('capturist.dashboard')); ?>" class="btn login-btn">Entrar</a>
                        </div>
                    </form>
                </div>
            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Yahir\actiscan\actiscan\resources\views/auth/login.blade.php ENDPATH**/ ?>