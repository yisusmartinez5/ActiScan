    ...
    <main class="dashboard-main assets-main">
        <div class="assets-page-container">
            ...
            <div class="assets-topbar">
                ...
                <div>
                    <a href="<?php echo e(route('capturist.assets.create')); ?>" class="new-asset-btn">
                    ...
                    <table class="assets-table">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <a href="<?php echo e(route('capturist.assets.show')); ?>" class="asset-view-btn" title="Ver activo">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" viewBox="0 0 16 16">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Yahir\actiscan\actiscan\resources\views/capturist/assets.blade.php ENDPATH**/ ?>