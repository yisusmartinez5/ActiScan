...
<div class="dashboard-page">
    ...
    <aside class="sidebar" id="sidebar">
        <div class="sidebar-menu">
            ...
            <a href="{{ route('capturist.categories') }}" class="sidebar-btn active">Categoría Activos</a>
            ...
            <section class="create-category-card">
                <form>
                    ...
                    <div class="create-actions">
                        <a href="{{ route('capturist.categories') }}" class="btn form-action-btn cancel-btn">Cancelar</a>
                        <a href="{{ route('capturist.categories') }}" class="btn form-action-btn create-btn">Crear categoria</a>
                    </div>
                </form>
            </section>
        </div>
